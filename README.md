...
# 📚 Curso de Informática - Instituto Paixão pela Missão (IPPM)

Bem-vindos ao repositório oficial de materiais do curso de Informática. Aqui você encontra os planos de aula e PDFs utilizados em nossos encontros, integrando tecnologia com princípios bíblicos.

## 🗓️ Cronograma e Materiais (PDF)
...
1. Procure a aula desejada na tabela acima.
2. Clique em **"Baixar PDF"**.
3. No site do GitHub, clique no botão de **Download** para salvar no seu dispositivo.

**Instituto Paixão pela Missão** - *Ensinando com Excelência e Fé (Colossenses 3:23).
Repositório de materiais e PDFs das aulas de Informática do Instituto Paixão pela Missão. 

Título: Curso de Informática - Instituto Paixão pela Missão
